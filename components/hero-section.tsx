...
export function HeroSection() {
  ...
  const toothY = useTransform(scrollYProgress, [0, 1], [0, 500])
  const toothScale = useTransform(scrollYProgress, [0, 1], [1, 1.8])
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-5rem)]">
          {/* Left Side - Text */}
          <motion.div className="flex flex-col justify-center pt-20 lg:pt-0" style={{ y: textY }}>
            <motion.div
          ...
          <motion.div className="relative flex items-center justify-center z-20" style={{ y: toothY, scale: toothScale }}>
            {/* Pedestal Shadow */}
            <motion.div
            ...
            >
              ...
              <motion.div
                ...
                style={{ transform: "translate(20px, 20px) scale(0.95)" }}
              >
                <img src="/images/tooth-hero.png" alt="" className="w-96 sm:w-[30rem] lg:w-[42rem] h-auto" aria-hidden="true" />
              </motion.div>

              {/* Medium shadow layer */}
              <motion.div
                className="absolute inset-0 blur-md opacity-15"
                style={{ transform: "translate(10px, 10px) scale(0.98)" }}
              >
                <img src="/images/tooth-hero.png" alt="" className="w-96 sm:w-[30rem] lg:w-[42rem] h-auto" aria-hidden="true" />
              </motion.div>

              {/* Soft shadow layer */}
              <motion.div className="absolute inset-0 blur-sm opacity-10" style={{ transform: "translate(5px, 5px)" }}>
                <img src="/images/tooth-hero.png" alt="" className="w-96 sm:w-[30rem] lg:w-[42rem] h-auto" aria-hidden="true" />
              </motion.div>
