                    ...
                    ...new Array(2).fill(0).map((_, index) => (
                        <React.Fragment key={index}>
                            {props.testimonials.map(({ description, image, title }, i) => (
                                <div className="p-5 sm:p-6 rounded-3xl border shadow-lg shadow-primary/5 w-[42vw] sm:w-[280px] xl:w-[300px] bg-white" key={i}>
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="font-bold text-sm sm:text-xl tracking-tight leading-5 text-foreground">{title}</div>
